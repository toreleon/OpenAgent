...
_Status: **Phase 0 + Phase 1 BUILT & live-verified** (2026-07-18, uncommitted); Phases 2–3 proposed. Owner: architecture. Extends the unified Artifacts feature (`src/lib/tools/artifacts.ts`, `src/components/artifacts/sandbox.ts`, `src/app/s/[slug]/route.ts`) from web-only to also building mobile apps._
