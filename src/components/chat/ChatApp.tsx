  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-main">
      ...
      <div className="flex h-full min-w-0 flex-1 flex-col">
        ...
        {error && (
          <div className="mx-auto mt-1 flex w-full max-w-chat items-center justify-between gap-3 rounded-lg border border-red-500/40 bg-red-500/10 px-4 py-2 text-sm text-danger">
